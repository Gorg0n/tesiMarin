...
from Library.ControlSystems.ControlSystem import Controller
...
output_controller = controller.energy_perfomance(production=Wind_power, T=T, time=time, p=p, hourly_h2_demand=h2_demand)
...
df_out_power.to_excel(f'Data_output/Complete_system/Power_flows.xlsx', index=False)
...
df_out_hydrogen.to_excel(f'Data_output/Complete_system/Hydrogen_flows.xlsx', index=False)
...
df_out_water.to_excel(f'Data_output/Complete_system/Water_flows.xlsx', index=False)