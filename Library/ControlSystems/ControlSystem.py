...
class Controller:
    def __init__(self, PEM, Desalinator, WaterStorage, Compressor, H2Storage, fuel, n_group, soc_water_in, soc_water_limit):
        ...
        :param n_group:float number of pem which do not operate simultaneously, but instead are activated sequentially, one after another 
    ...
    def energy_perfomance(self, production, T, time, p, hourly_h2_demand):
        '''
        ...
        for i in range(len_ref):
            ...
            # print('PRODUCTION OUT', production_out)
            ...
            # print('soc_water_tot 1', soc_wat_tot)
            ...
            water_produced_tot += water_produced
